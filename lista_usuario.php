			...
			<div class="span12">
				<table class="table table-striped table-hover ">
					...
					<tr>
						...
						<td><ul class="">
								<li class="btn-group">
									<a class="btn btn-small" href="perfil.php?rut=<?php echo $respuesta_usuario["us_Rut"]; ?>">
										<i class="icon-user"></i> Perfil</a>
									<a class="btn btn-small" href="editar_usuario.php?rut=<?php echo $respuesta_usuario["us_Rut"]; ?>">
										<i class="icon-edit"></i> Editar </a>
									<a class="btn btn-small" href="eliminar_usuario.php?rut=<?php echo $respuesta_usuario["us_Rut"]; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el usuario?')">
